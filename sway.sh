...
sudo apt install -y sway waybar swaylock swayidle swaybg swayimg xwayland wlogout
...
# Others
sudo apt install -y figlet galculator cpu-x udns-utils whois curl tree neofetch ranger htop
